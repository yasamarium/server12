...
class Settings:
    ...
    MODEL_NAME: str = os.getenv("MODEL_NAME", "smollm2-1.7b")
    MODEL_FILE: str = os.getenv("MODEL_FILE", "smollm2-1.7b-instruct-q4_k_m.gguf")
    MODEL_PATH: str = os.getenv(
        "MODEL_PATH",
        str(Path(__file__).resolve().parent.parent / "models" / os.getenv("MODEL_FILE", "smollm2-1.7b-instruct-q4_k_m.gguf")),
    )
    MODEL_URL: str = os.getenv("MODEL_URL", "https://huggingface.co/HuggingFaceTB/SmolLM2-1.7B-Instruct-GGUF/resolve/main/smollm2-1.7b-instruct-q4_k_m.gguf")
